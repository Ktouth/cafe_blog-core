...
ExampleDBData[:author_logs] = [
  {:id => 1, :time => Time.local(2004, 11, 23, 1, 11, 11), :host => '11-09-111-13.host.example.org', :author_id => 1},
  {:id => 2, :time => Time.local(2005, 7, 11, 8, 12, 20), :host => 'org.this.host-name@11.22.33.44',},
  {:id => 3, :time => Time.local(2005, 10, 22, 3, 13, 9), :host => 'ppp1111.kumamoto11.qibb.ja', :author_id => 1,},
  {:id => 4, :time => Time.local(2006, 6, 12, 9, 14, 17), :host => 'ppp1111.kumamoto11.qibb.ja', :author_id => 1,},
  {:id => 5, :time => Time.local(2007, 3, 7,22, 15, 28), :host => 'unknown.host.name',},
  {:id => 6, :time => Time.local(2009, 7, 5,18, 16, 16), :host => 'ppp1111.kumamoto11.qibb.ja', :author_id => 1,},
  {:id => 7, :time => Time.local(2010, 12, 25,14, 17, 45), :host => '11-09-111-13.host.example.org',},
  {:id => 8, :time => Time.local(2011, 1, 1,13, 18, 37), :host => 'ppp192-168-0-2.tokyo.org', :author_id => 3,},
  {:id => 9, :time => Time.local(2011, 2, 21,22, 19, 55), :host => 'unknown.host.name',},
  {:id => 10, :time => Time.local(2011, 3, 23, 1, 20, 59), :host => 'ppp192-168-0-2.tokyo.org', :author_id => 3,},
]

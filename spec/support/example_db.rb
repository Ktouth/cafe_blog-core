...
ExampleDBData[:tags] = [
  {:id => 1, :name => '未分類', :code => 'no_group',},
    {:id => 7, :name => 'テスト', :group_id => 1,},
    {:id => 8, :name => 'いぐざんぽー', :group_id => 1,},
    {:id => 13, :name => 'example', :group_id => 1,},
    {:id => 16, :name => 'tag', :group_id => 1,},
    {:id => 9, :name => 'unknown', :code => 'unknown', :group_id => 1,},
  {:id => 10, :name => '文書',},
  {:id => 11, :name => '実務',},
  {:id => 2, :name => '記',},
    {:id => 5, :name => '日記', :code => 'diary', :group_id => 2,},
    {:id => 14, :name => '自分メモ', :group_id => 2,},
    {:id => 15, :name => 'twitter', :code => 'twitter', :group_id => 2,},
    {:id => 6, :name => 'facebook', :group_id => 2,},
  {:id => 3, :name => 'ライブラリ', :code => 'library',},
  {:id => 4, :name => 'ゲーム',},
    {:id => 12, :name => 'アニメ化', :group_id => 4,},
]
